        ...
        <div class="bg-light rounded-4 py-5 px-4 px-md-5">
            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-lg-8 col-xl-6">
                    ...
                    @endif
                    <form id="contactForm" action="{{ route('sendMessa') }}" method="post">
                        @csrf
                        ...
                        <!-- Phone number input-->
                        <div class="form-floating mb-3">
                            <input class="form-control" id="phone" name="phone" type="number" pattern="(10)[0-9]"
                                maxlenght="10" minlenght="10" title="Solo 10 Digitos" placeholder="(123) 456-7890"
                        ...
                        <!-- Submit Button-->
                        <div class="d-grid"><input class="btn btn-primary btn-lg" id="submitButton" type="submit">
                        </div>
                    </form>
                </div>
            </div>
